...
startTime = time.time()  # Record start time for loading VGG16 model
print("Loading pre-trained VGG16 model...")  # Print progress message
...
)  # Extract feature extractor from VGG16 model
endTime = time.time()  # Record end time for loading VGG16 model
print(
    f"Loaded VGG16 model in {(endTime - startTime):.2f} seconds."
)  # Print loading time
